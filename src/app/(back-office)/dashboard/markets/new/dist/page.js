...
var Page = function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, apiRequest_1.makePostRequest({
                            ...
                            reset: reset,
                            redirect: function () { return router.push("/dashboard/markets"); }
    ...
    return (React.createElement("div", null,
        React.createElement(Heading_1["default"], { title: "New Market", returnBtn: true, handleBack: router.back }),
        React.createElement("form", { onSubmit: handleSubmit(onSubmit), className: "w-full max-w-4xl p-4 bg-white  errors border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto my-3" },
            React.createElement("div", { className: "grid gap-4 sm:grid-cols-2 sm:gap-6" },
                React.createElement(TextInput_1["default"], { name: "title", label: "Market Title", register: register, errors: errors, className: "w-full" }),
                React.createElement(SelectInput_1["default"], { label: "Select Categories", name: "categories", register: register, options: category, multiple: true, className: "w-full" }),
                React.createElement(TextAreaInput_1["default"], { label: "Market Description", name: "description", register: register, errors: errors }),
                React.createElement(ImageInput_1["default"], { label: "Market Logo", setImageUrl: setImageUrl, imageUrl: imageUrl, endpoint: "marketUploader" }),
                React.createElement(ToggleInput_1["default"], { trueTitle: "Active", falseTitle: "Draft", label: "Market status", name: "isActive", register: register, isActive: isActive, checked: true })),
            React.createElement(Button_1["default"], { buttonTitle: "Create Market", loadTitle: "Creating...", isLoading: loading, type: "submit" }))));
};
