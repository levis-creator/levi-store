        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    // data.slug = slug;
                    data.logo = imageUrl;
                    return [4 /*yield*/, apiRequest_1.makePostRequest(setLoading, "api/markets", data, "Markets", reset).then(function () { return setImageUrl(""); })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("form", { onSubmit: handleSubmit(onSubmit), className: "w-full max-w-4xl p-4 bg-white  errors border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto my-3" },
            React.createElement("div", { className: "grid gap-4 sm:grid-cols-2 sm:gap-6" },
                React.createElement(TextInput_1["default"], { name: "title", label: "Market Title", register: register, errors: errors }),
