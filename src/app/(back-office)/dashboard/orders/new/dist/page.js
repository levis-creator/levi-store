...
var Page = function () {
    ...
    return (React.createElement("div", null,
        React.createElement(Heading_1["default"], { title: "New Banner", returnBtn: true }),
        React.createElement("form", { onSubmit: handleSubmit(onSubmit), className: "w-full max-w-4xl p-4 bg-white  errors border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto my-3" },
            React.createElement("div", { className: "grid gap-4 sm:grid-cols-2 sm:gap-6" },
                ...
                React.createElement(ImageInput_1["default"], { label: "Banner Image", setImageUrl: setImageUrl, imageUrl: imageUrl, endpoint: "imageUploader" }),
                React.createElement(ToggleInput_1["default"], { trueTitle: "Publish", falseTitle: "Draft", label: "Publish order", name: "isPublished", register: register, isActive: isActive, checked: true })),
