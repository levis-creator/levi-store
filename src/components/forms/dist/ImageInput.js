...
var ImageInput = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: className },
        react_1["default"].createElement("div", { className: "flex justify-between items-center mb-4" },
            react_1["default"].createElement("label", { htmlFor: "course-image", className: "block text-sm font-medium leading-6 text-slate-800 dark:text-slate-50" }, label),
        ...
        imageUrl ? (react_1["default"].createElement(image_1["default"], { src: imageUrl, alt: "Item image", width: 1000, height: 667, className: "w-full h-64 object-contain" })) : (react_1["default"].createElement(uploadThing_1.UploadDropzone, { endpoint: endpoint, onClientUploadComplete: function (res) {
                setImageUrl(res[0].url);
                // Do something with the response
                console.log("Files: ", res);
                console.log("Upload Completed");
                react_hot_toast_1["default"].success("Upload Completed");
            }, onUploadError: function (error) {
                // Do something with the error.
                console.log("ERROR! " + error.message);
                react_hot_toast_1["default"].error("ERROR! " + error.message);
            } }))));
};
