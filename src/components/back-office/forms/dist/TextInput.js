...
var TextInput = function (_a) {
    ...
    return (React.createElement("div", { className: className },
        ...
        React.createElement("div", { className: "mt-2" },
            React.createElement("input", __assign({}, register("" + name, { required: isRequired }), { type: type, name: name, id: name, defaultValue: defaultValue, autoComplete: name, className: "block w-full rounded-md border-0 py-3 dark:bg-slate-600 text-slate-800 dark:text-slate-50 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-slate-400  focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6", placeholder: "Type the " + label.toLowerCase() })),
