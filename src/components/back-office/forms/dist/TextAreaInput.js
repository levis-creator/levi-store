...
var TextAreaInput = function (_a) {
    ...
    return (React.createElement("div", { className: className },
        ...
        React.createElement("div", { className: "mt-2" },
            React.createElement("textarea", __assign({}, register("" + name, { required: isRequired }), { name: name, id: name, rows: 3, className: "block dark:text-slate-50 w-full rounded-md border-0 py-1.5 bg-transparent text-slate-900 shadow-sm ring-1 ring-inset ring-slate-400 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6", defaultValue: "", placeholder: "Type the " + label.toLowerCase() })),
