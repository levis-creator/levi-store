...
var Heading = function (_a) {
    var title = _a.title, additionalBtn = _a.additionalBtn, returnBtn = _a.returnBtn;
    return (react_1["default"].createElement("div", { className: "w-full flex justify-between py-4 mb-4" },
        ...
        returnBtn && (react_1["default"].createElement("button", { className: "text-slate-800 dark:text-slate-50 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-full p-3 " },
