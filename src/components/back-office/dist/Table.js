        ...
        react_1["default"].createElement("table", { className: "w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 " },
            react_1["default"].createElement("thead", { className: "text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400" },
                react_1["default"].createElement("tr", null,
                    react_1["default"].createElement("th", { scope: "col", className: "p-4" },
                        react_1["default"].createElement("div", { className: "flex items-center" },
                            react_1["default"].createElement("input", { id: "checkbox-all-search", type: "checkbox", className: "w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" }),
                            react_1["default"].createElement("label", { htmlFor: "checkbox-all-search", className: "sr-only" }, "checkbox"))),
                    heads.map(function (head, i) { return (react_1["default"].createElement("th", { scope: "col", className: "px-6 py-3", key: i }, head)); }))),
            react_1["default"].createElement("tbody", null, pgeData.map(function (item, i) { return (react_1["default"].createElement("tr", { key: i, className: "bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" },
                react_1["default"].createElement("td", { className: "w-4 p-4" },
                    react_1["default"].createElement("div", { className: "flex items-center" },
                        react_1["default"].createElement("input", { id: "checkbox-table-search-1", type: "checkbox", className: "w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" }),
                        react_1["default"].createElement("label", { htmlFor: "checkbox-table-search-1", className: "sr-only" }, "checkbox"))),
                heads.map(function (head, i) { return (react_1["default"].createElement("td", { key: i, className: "px-6 py-4" }, item[head])); }))); }))),
